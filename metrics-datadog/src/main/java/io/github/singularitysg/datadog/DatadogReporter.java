...
import io.github.singularitysg.datadog.transport.HttpTransport;
import io.github.singularitysg.datadog.transport.Transport;
import io.github.singularitysg.datadog.transport.UdpTransport;
...
/**
 * DatadogReporter attempts to map the Dropwizard Metrics types to the Datadog types.
 *
 * | Dropwizard | Datadog                                                                           |
 * |------------|-----------------------------------------------------------------------------------|
 * | Meter      | Count as Datadog Counter 1m, 5m, 15m rates as Datadog Gauge                       |
 * | Counter    | Datadog Gauge                                                                     |
 * | Timer      | Count as Datadog Gauge Percentiles as Datadog Gauge Aggregations as Datadog Gauge |
 * | Gauge      | Datadog Gauge                                                                     |
 * | Histogram  | Count as Datadog Gauge Percentiles as Datadog Gauge Aggregations as Datadog Gauge |
 */
public class DatadogReporter extends ScheduledReporter {
  ...
  // The Dropwizard meter should be mapped to a Datadog counter as mentioned in this PR
  // https://github.com/coursera/metrics-datadog/pull/32
  // However, for some reason, the meter is mapped to a Datadog gauge.
  ...
  public static class Builder {
     ...
     * @see HttpTransport
     * @see UdpTransport
     * @param transport Transport used with the reporter
     * @return {@link Builder}
     */
